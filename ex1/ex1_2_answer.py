...
kfold = StratifiedKFold(y, n_folds=10, shuffle=True, random_state=1)
...
for k, (train, test) in enumerate(kfold):
    ...
    score = knn.score(X_test_std, y[test])
    ...
    fscore = precision_recall_fscore_support(y[test], knn.predict(X_test_std))
